...
class circuit_graph 
{
    private:
        ...
        std::map<unidirected_edge, component> edge_to_component;
    ...
    public:
        ...
        const unidirected_graph& get_graph() const {
            return graph;
        }

        const std::map<unidirected_edge, component>& get_edge_map() const {
